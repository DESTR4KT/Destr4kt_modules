...
class ServInfoMod(loader.Module):
    ...
    """
    strings = {"name": "ServInfo", "version": "2.5.0"} # Версия изменена на 2.5.0
    ...
    async def servinfocmd(self, message):
        ...
        # Эмодзи, выбираемые в зависимости от Premium статуса
        EMOJI = {
            'sys_header': "🖥️",
            'bot_header': "🤖",
            'dev': "✨"
        ...
        # Если Premium, используем соответствующие эмодзи
        if self.premium:
        ...
        await message.edit(f"{EMOJI['sys_header']} <b>Анализ системы...</b>", parse_mode='html')
        ...
        try:
            ...
            # --- Формирование вывода с цитированием ---
            system_info_block = (
                f"OS: {os_info} {arch}\n"
